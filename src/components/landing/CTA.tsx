          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Trusted by a growing community of users for instant dental
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <Button
                size="lg"
                className="px-6 py-3 font-semibold bg-linear-to-r from-primary to-primary/90 hover:from-primary/95 hover:to-primary/85 shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl hover:scale-[1.02]">
              ...
              <Button
                size="lg"
                variant="outline"
                className="px-6 py-3 font-semibold border border-primary/20 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 rounded-xl hover:scale-[1.02]">
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <Image
                  ...
                  width={300}
                  height={300}
                  className="relative w-80 h-auto drop-shadow-xl hover:scale-[1.06] transition-transform duration-500"
                  priority
                />
              </div>
